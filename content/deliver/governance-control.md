...
### 1. Don’t slow down delivery{.text-color-brand-tertiary .margin-block-start-md .margin-block-end-none }
...
### 2. Decisions when they’re needed, at the right level{.text-color-brand-tertiary .margin-block-start-md .margin-block-end-none }
...
### 3. Do it with the right people{.text-color-brand-tertiary .margin-block-start-md .margin-block-end-none}
...
### 4. Go see for yourself{.text-color-brand-tertiary .margin-block-start-md .margin-block-end-none }
...
### 5. Only do it if it adds value{.text-color-brand-tertiary .margin-block-start-md .margin-block-end-none }
...
### 6. Trust and verify{.text-color-brand-tertiary .margin-block-start-md .margin-block-end-none }
