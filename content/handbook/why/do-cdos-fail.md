...
## 4. Resistance to change{.h3-style}
...
## 6. Organisational structure{.h3-style}
...
This may be an issue in particular in a fast-growing company. Project leadership at scale is a huge challenge, and though training can be a vital aid in rising to it there's nothing quite the equal to experience and maturity — being able to say 'aah, it's one of these' and respond accordingly is powerful.
...
Project leadership is an equal partner in that goal with all the other capabilities and specialisms in the company — the enabler of the experts, not the leader of the pack.
